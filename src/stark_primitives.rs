...
pub(crate) type MyCompress = CompressionFunctionFromHasher<ByteHash, 2, 32>;
pub(crate) type ValMmcs = MerkleTreeMmcs<Val, u8, FieldHash, MyCompress, 32>;
...
pub(crate) type Pcs = CirclePcs<Val, ValMmcs, ChallengeMmcs>;
...
pub type OuterHash = MultiField32PaddingFreeSponge<Val, Bn254Fr, OuterPerm, 3, 16, 8>;
...
pub type OuterDft = Radix2DitParallel<Val>;
...
pub(crate) type Mersenne31Keccak = StarkConfig<Pcs, Challenge, Challenger>;
pub(crate) type Mersenne31Poseidon2 = StarkConfig<OuterPcs, Challenge, OuterChallenger>;
...
//     let mut res: p3_bn254_fr::FFBn254FrRepr = <p3_bn254_fr::FFBn254Fr as ff::PrimeField>::Repr::default();
...
// pub fn wrap_fri_config() -> FriConfig<ChallengeMmcs> {
//     let byte_hash = ByteHash {};
//     let field_hash = FieldHash::new(Keccak256Hash {});
//     let compress = MyCompress::new(byte_hash.clone());
//     let val_mmcs = ValMmcs::new(field_hash, compress);
...
pub fn default_stark_config() -> Mersenne31Keccak {
    let byte_hash = ByteHash {};
    let field_hash = FieldHash::new(Keccak256Hash {});
    let compress = MyCompress::new(byte_hash.clone());
    let val_mmcs = ValMmcs::new(field_hash, compress);
    ...
    Mersenne31Keccak::new(pcs)
}

// pub fn wrap_stark_config() -> Mersenne31Poseidon2 {
